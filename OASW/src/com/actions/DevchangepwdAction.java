...
import com.forms.DevchangepwdForm;

public class DevchangepwdAction extends DispatchAction {
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {

		DevchangepwdForm devchangepwdForm = (DevchangepwdForm) form;
		HttpSession session = request.getSession();
		ArrayList al =(ArrayList)session.getAttribute("empDetails");
		String username = (String)al.get(1);
		System.out.println("username------"+username);
		devchangepwdForm.setUserName1(username);
	...
	public ActionForward submitChangePwd(ActionMapping mapping, ActionForm form,
		...
		String userName = devchangepwdForm.getUserName1();
		String password = devchangepwdForm.getExistingPwd();
		String newPassword = devchangepwdForm.getNewPwd();
		String confirmPassword = devchangepwdForm.getConfirmPwd();
		...
		if (epass.equals(password)) {
			...
			if (newPassword.equals(confirmPassword)) {
				...
				devchangepwdForm.setExistingPwd("");
				devchangepwdForm.setNewPwd("");
				devchangepwdForm.setConfirmPwd("");
