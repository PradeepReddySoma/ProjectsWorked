...
import com.forms.DevUpdateForm;
 
public class DevUpdateAction extends DispatchAction {
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		DevUpdateForm empUpdateForm = (DevUpdateForm) form;
		...
		ResultSet rs = null;
		Statement stmt = null;
		String Sql = "SELECT * FROM ASSIGNED_TASK_DETAILS WHERE TASK_NUMBER = '"+taskNo+"' AND UNIT = '"+com+"'";
		try {
