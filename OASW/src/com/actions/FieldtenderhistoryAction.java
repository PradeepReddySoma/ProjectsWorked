...
import com.forms.FieldtenderhistoryForm;
import com.forms.TenderDisplayForm;
import com.forms.TenderhistoryForm;

public class FieldtenderhistoryAction extends DispatchAction {
	
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		FieldtenderhistoryForm tenderdisplayForm = (FieldtenderhistoryForm) form;// TODO Auto-generated method stub
	...
	public ActionForward view(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		FieldtenderhistoryForm tenderdisplayForm = (FieldtenderhistoryForm) form;
		...
		FieldtenderhistoryForm tf = null;
		try {
			stmt = con.createStatement();
			rs = stmt.executeQuery(Sql);
			while (rs.next()) {
				tf = new FieldtenderhistoryForm();
