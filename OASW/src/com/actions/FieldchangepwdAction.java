...
import com.forms.FieldchangepwdForm;

public class FieldchangepwdAction extends DispatchAction {
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {

		FieldchangepwdForm pwdForm = (FieldchangepwdForm) form;
	...
	public ActionForward submitChangePwd(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		FieldchangepwdForm changePasswordForm = (FieldchangepwdForm) form;
		HttpSession session = request.getSession();
