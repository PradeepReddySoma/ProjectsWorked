...
import com.forms.FieldworkviewForm;
import com.forms.WorkviewForm;

public class FieldworkviewAction extends DispatchAction {
	
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		FieldworkviewForm updateTaskForm = (FieldworkviewForm) form;
		...
		try { 
			...
			while (rs.next()) {
				updateTaskForm = new FieldworkviewForm();
