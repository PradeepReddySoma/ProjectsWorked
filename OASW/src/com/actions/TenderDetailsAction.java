...
public class TenderDetailsAction extends DispatchAction {
	
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)throws Exception{
		TenderDetailsForm tenderdetailsForm = (TenderDetailsForm) form;
		...
		tenderdetailsForm.setUnit(com1);  
			   ...
			   prepare = con.prepareStatement(sql);
			    ...
			    if (t > 0) {
				     Statement stmt1 = con.createStatement();
						...
						if(com1.equalsIgnoreCase("IngroInfo Software Solutions pvt ltd."))
				        { 
							 String Sql = "SELECT * FROM TENDERDETAILS WHERE SERNUM LIKE '%_IGI%' ORDER BY SERNUM ASC";
	    	     ...
	    	     return mapping.findForward("tenderdetails");
			    } else {
