...
import com.forms.AccountantconmgntForm;
import com.forms.ContactManageForm;

public class AccountantconmgntAction extends DispatchAction {
	
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws SQLException {
		AccountantconmgntForm contactManageForm = (AccountantconmgntForm) form;// TODO Auto-generated method stub
        ...
        { 
			String Sql = "SELECT * FROM CONTACT_MANAGEMENT WHERE SLNO LIKE '%_IGI%' ORDER BY SLNO DESC";
		...
		while (rs.next()) {
		 ...
		 String completeNewVersion = "Acc_IGI-" + newVersion;
        	...
        	String Sql = "SELECT * FROM CONTACT_MANAGEMENT WHERE SLNO LIKE '%_RK%' ORDER BY SLNO DESC";
			rs = stmt.executeQuery(Sql);
    		int count = 1;
    		int count1 = 1;
    		while (rs.next()) {
