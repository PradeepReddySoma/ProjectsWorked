...
public class TenderhistoryAction extends DispatchAction {
	
	public ActionForward display(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		TenderhistoryForm tf1 = (TenderhistoryForm) form;// TODO Auto-generated method stub
	...
	public ActionForward view(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		TenderhistoryForm tenderdisplayForm = (TenderhistoryForm) form;
		...
		String name = tenderdisplayForm.getName();
		String no = tenderdisplayForm.getNo();
		...
		TenderhistoryForm tf = null;
		try {
			stmt = con.createStatement();
			rs = stmt.executeQuery(Sql);
			while (rs.next()) {
				tf = new TenderhistoryForm();
				...
				tf.setTenderNumber(rs.getString(13));
