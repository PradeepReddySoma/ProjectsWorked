...
function writeJavaViewer_part1(browser, jdkVer, type, lang, rptName, sf, promptOnRefresh, param)
{
	...
	if (browser == "msie")
	{
		...
		document.write("<param name=archive value=\"ReportViewer.jar\">");
		...
		document.write("archive=\"ReportViewer.jar\"");		
