...
function test() {
	...
	var url = "fieldtenderhistory.do?method=view";
...
.scroll {
	...
	<html:form action="/fieldtenderhistory">
		<body class="back">
			<div class="header">
			...
			<div>
				<br />
				<br />
				<table class="background" style="width:1255px;margin-left:50px;">
					<tr class="rowHeader">
						<th colspan="24" id="displayworkstart">

							<b style="font-family: serif; font-size: 17px;">Tender
								History</b>
					</tr>
					...
					<tr class="tablerowdark">
						...
						<td>
							<html:select property="yeardetails" styleId="padleft" styleClass="textField"
					 ...
					 <td>
						...
						<td>
							<html:text property="fromdate" styleId="datepicker"
								styleClass="textField" style="margin-left:4px;padding-left:4px;" readonly="true"></html:text>
						</td>
						...
						<td id="bright">
							<html:text property="todate" styleId="datepicker1" style="padding-left:4px;margin-left:-4px;"
			...
			<logic:notEmpty name="displaymanag" scope="request">
				<table width="1280px" cellpadding="1" cellspacing="1" align="center"
					class="background1" style="margin-left: 45px">
					<tr class="rowHeader1">
						<td>
							<b style="font-size: 12px; margin-left: 65px; width: auto">Slno</b>
						</td>
						<td>
							<b style="font-size: 12px; margin-left: 35px;margin-right:-20px; width: auto;">DOE</b>
						</td>
						<td>
							<b style="font-size: 12px; margin-left: 95px; width: auto">Tenderdetails</b>
						</td>
						<td>
							<b style="font-size: 12px; margin-left: -70px;margin-right:-32px;width: auto">Contact
								Name</b>
						</td>
						<td>
						...
						<td>
							<b style="font-size: 12px; margin-right: 33px; width: auto">EMD</b>
						</td>
						<td>
							<b style="font-size: 12px; width: auto; margin-right: -20px;margin-left:-5px;">DocumentAttached</b>
						</td>
						<td>
							<b style="font-size: 12px; margin-right: 25px; width: auto">Delete</b>
						</td>
					</tr>
				</table>
				<tr>
					<td>
						<div class="scroll" style="width: 1280px; margin-left: 45px;">
							<display:table class="BinInfo" name="displaymanag"
								id="displaymanag" pagesize="25"
								requestURI="fieldtenderhistory.do" cellpadding="2"
								cellspacing="15" export="true">
								...
								<display:column sortable="false" title="EMD" property="emd" 
									headerClass="heading1" class="accountsh1"></display:column>
								<display:column sortable="false" title="Document Attached"
									property="slno1" paramProperty="slno1" paramId="slno1"
									href="fieldtenderhistory.do?method=download&slno1=${row.slno1}"
									headerClass="heading1" class="accountsh1"></display:column>
								<display:column sortable="false" title="Delete"
									property="deleterec" paramProperty="deleterec"
									paramId="deleterec"
									href="fieldtenderhistory.do?method=deleterecords&deleterec=${row.deleterec}"
									headerClass="heading1" class="accountsh1"></display:column>

								<display:setProperty name="export.pdf.filename"
									value="fieldtender.pdf" />
								<display:setProperty name="export.excel.filename"
									value="fieldtender.xls" />
