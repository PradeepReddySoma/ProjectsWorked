...
<html>
	...
	var URL = "acccontact_name.do?method=displayrecord";
	...
	function display()
           {
               var url = "acccontact_name.do?method=displayHistory";
               document.forms[0].action = url;
               document.forms[0].submit();
           }
	...
	width: 100%;
		...
		<html:form action="/acccontact_name">
		<body class="back">	
			<div class="header">
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="acccontact_nameForm" property="message" /></b>
				</div>
				...
				<table width="89%" cellpadding="1" cellspacing="1" class="background1" style="margin-left: 83px">
					...
					<tr>
						...
						<div class="scroll" style="width: 89%;margin-left: 83px">
						    <display:table class="BinInfo" name="empmaster" id="empmaster" pagesize="25" requestURI="acccontact_name.do" cellpadding="3" cellspacing="3" export="true">
