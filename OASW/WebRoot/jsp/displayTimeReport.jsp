...
<html>
	...
	var URL = "adminworktime.do?method=displayrecords";
    ...
    var slno=f1.empid.value;
    var name=f1.name.value;
    /* var desgn=f1.desgn.value; */
    var fdate=f1.starttime.value;
    var tdate=f1.totime.value;
    ...
    /* if(f1.daily.value == "")
    {
        ...
        return false;
				...
				var url = "adminworktime.do?method=generatereport";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		...
		<div class="mainheader">
			...
			<div class="noscroll" style="margin-top:-25px;">
				<%-- <div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="adminworktimeForm" property="message" /></b>
				</div> --%>
				<center>
               <br>
					...
					<table class="background" style="width: 1270px;margin-left:90px;" >
						<tr class="rowHeader">
							<th colspan="14" id="displayworkstart">
								...
								<b style="font-family: serif;font-size: 20px;color: white">Timing Report</b>
							</th> 
						</tr> 
						<tr class="plainback">
...
<% %>
  <td  class="leftie">
								<%-- <html:button property="method"  styleClass="button_width2"
									...
									<html:button property="method" styleId="labelButton"   styleClass="button_width2"
									style="width:100px;margin-left:0px;">Emp_Id *</html:button>
							</td><% if(list!=null){%>
  <td>
      <html:select property="empid" styleClass="textField" style="width: 80px" onchange="submitDetails()"  >
   ...
   <%} %>
							...
							<td>
								<html:text property="starttime" styleId="datepicker" styleClass="textField" style="margin-left: 0px;width:80px;padding-left:4px;"  readonly="true"></html:text>
							</td>
							...
							<td>
								<html:text property="totime" styleId="datepicker1" style="margin-left:0px;width:80px;padding-left:4px;" styleClass="textField" readonly="true"></html:text>
							</td>
								<%-- <td >
								<html:button property="method" styleClass="button_width2"
