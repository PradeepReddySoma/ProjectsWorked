...
<html>
    ...
    if(f1.remarks.value == "")
    {
        ...
        return false;
               ...
               var url = "accountantconmgnt.do?method=submitDetails";
    ...
    overflow:hidden;
		...
		<html:form action="/accountantconmgnt">
	<body class="back">	
			<div class="header">
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="accountantconmgntForm" property="message" /></b>
				</div>
				...
				<div> 
					<table  class="background" style="margin-left: 45px;width: 1250px" >
						<tr class="rowHeader">
		    ...
		    <html:text property="unit" readonly="true" styleId="padleft" style="height:30;width:100;margin-top:20" styleClass="textField" style="width:250px" ></html:text>
						...
						<tr class="tablerowdark">
							...
							<td>
                              ...
                              <html:text property="slno" readonly="true"  styleId="padleft"  style="height:30;width:100;margin-top:20" styleClass="textField" style="width:80px" ></html:text>
							...
							<td>
								<html:text property="contact"  styleId="padleft" styleClass="textField" style="width:100px"></html:text>
							</td>
						<td> 
								<%-- <html:button property="method" styleClass="button_width2"
									style="width:100px;margin-left:-3px;background-color: #F5A13B">Place *</html:button> --%>
									<html:button property="method" styleClass="button_width2" styleId="labelButton"
									style="width:100px;margin-left:-3px;">Place *</html:button>
							</td>
							<td>
							...
							<td>
								...
								<html:text property="remarks"  styleId="padleft" styleClass="textField" style="width:260px" ></html:text>
							</td>
						...
						<tr class="rowHeader">
							<th colspan="10" id="adminworkend">
								<html:button property="method" styleClass="button_width"  style="margin-left:50px;" onclick="contact1()">Submit</html:button>
								<html:button property="method" styleClass="button_width" style="margin-left:30px" onclick="display()">Display</html:button>
