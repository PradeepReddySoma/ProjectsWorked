...
<html:form action="/devupdatetask">	
	<body class="back">
			<div class="header">
...
<div style="margin-left: 40px; width: 1370px;">			
				<logic:notEmpty name="updatedTasks" scope="request">
					<table width="1200px" cellpadding="1" cellspacing="1" align="center" class="background1" style="margin-left: 30px">
						<tr class="rowHeader">
						...
						<td><b style="font-size: 12px;margin-right: 40px">Updated Date</b></td>
						<td><b style="font-size: 12px;margin-right: 80px">Status</b></td>
						<td><b style="font-size: 12px;margin-right: 10px">Remarks</b></td>
						</tr>
						</table>
						<tr>
							<td>
							<div class="scroll" style="margin-left: 40px; width: 1220px;">
								<display:table style="width:1200px" name="updatedTasks" id="updatedTasks" pagesize="25" requestURI="devupdatetask.do" cellpadding="1" cellspacing="2" class="historydistables" export="true">
