...
<html>
     ...
     if(f1.status.value == "")
    {
        ...
        return false;
			...
			var url = "fieldwork.do?method=sendwork";
			document.forms[0].action = url;
			document.forms[0].submit();
		}
		function workhistory() {
		var url = "fieldwork.do?method=showhistory";
			document.forms[0].action = url;
			document.forms[0].submit();
		}
		</script >
	...
	width: 100%;
		...
		<html:form action="/fieldwork">
			...
			<div class="right_content">
				...
				<div>
					<table class="background" style="height: 100px;width: 1280px;margin-left:40px">
						<tr class="rowHeader">
						...
						<td colspan="8" id="bright">
                              ...
                              <html:text property="date" styleId="padleft" styleClass="textField" style="width:70px" readonly="true"></html:text>
               ...
               <td>
						...
						<tr class="rowHeader">
							<th colspan="25" id="adminworkend" style="padding-top: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;">
			...
			<br/>
				...
				<table width="89%" cellpadding="1" cellspacing="1" align="center" class="background1" style="margin-left: 75px">
					...
					<td><b style="font-size: 12px;margin-right: 25px">WORKDETAILS</b></td>
					...
					<tr>
						<td>
						<div class="scroll" style="margin-left: 75px;width: 89%">
						<display:table class="BinInfo" name="empmaster" id="empmaster" pagesize="25" requestURI="fieldwork.do" cellpadding="3" cellspacing="3" export="true">
						...
						<display:setProperty name="export.pdf.filename" value="fworkdetails.pdf" />
						<display:setProperty name="export.excel.filename" value="fworkdetails.xls" />
