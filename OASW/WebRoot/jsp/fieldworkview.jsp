...
.scroll {
	...
	width: 100%;
		...
		<html:form action="/fieldworkview">
		<body class="back">
			<div class="header">
...
<div style="margin-left: 40px; width: 1370px;">			
				<logic:notEmpty name="updatedTasks" scope="request">
					<table width="1200px" cellpadding="1" cellspacing="1" align="center" class="background1" style="width:1260px;margin-left: 10px">
						<tr class="rowHeader">
							 <th colspan="24" id="fldwrkvwtableheader">
						...
						<td><b style="font-size: 12px;margin-right: 20px">Task Name</b></td>
						<td><b style="font-size: 12px;margin-right: 30px">Updated Date</b></td>
						<td><b style="font-size: 12px;margin-right: 60px">Status</b></td>
						<td  id="dwnldborder"><b style="font-size: 12px;margin-right: 30px">Remarks</b></td>
						</tr>
						</table>
						<tr>
							<td>
							<div class="scroll" id="fieldworkviewdata" style="width:1256px;height:296px;margin-left:10px;">
								<display:table style="width:1200px" name="updatedTasks" id="updatedTasks" pagesize="25" requestURI="fieldworkview.do" cellpadding="1" cellspacing="2" class="historydistables" export="true">
							...
							<display:setProperty name="export.pdf.filename" value="fieldtaskupdate.pdf" />
										<display:setProperty name="export.excel.filename" value="fieldtaskupdate.xls" />
