...
<html>
     ...
     if(f1.status.value == "")
    {
        ...
        return false;
			...
			var url = "accwork.do?method=sendwork";
			document.forms[0].action = url;
			document.forms[0].submit();
		}
		function workhistory() {
		var url = "accwork.do?method=showhistory";
			document.forms[0].action = url;
			document.forms[0].submit();
		}
		</script >
	...
	width: 100%;
		...
		<html:form action="/accwork">
			...
			<div class="right_content">
				...
				<div>
					<table class="background" style="height: 100px;margin-left: 50px;width: 1260px" >
						<tr class="rowHeader">
               ...
               <td>
						...
						<td id="bright">
						<html:select property="status" styleClass="textField" styleId="padleft" style="width:100px">
			...
			<br/>
				...
				<table width="88%" cellpadding="1" cellspacing="1" align="center" class="background1" style="margin-left: 75px">
					...
					<tr>
						<td>
						<div class="scroll" style="width: 88%;margin-left: 75px" >
						<display:table class="BinInfo" name="empmaster" id="empmaster" pagesize="25" requestURI="accwork.do" cellpadding="3" cellspacing="3" export="true">
				        ...
				        <display:setProperty name="export.pdf.filename" value="accWork.pdf" />
										<display:setProperty name="export.excel.filename" value="accWork.xls" />
