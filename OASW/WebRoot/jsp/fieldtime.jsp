...
<html>
             ...
             if(f1.starttime.value == "")
    {
        ...
        return false;
			...
			var url = "fieldtime.do?method=sendwork";
             ...
             if(f1.totime.value == "")
    {
        ...
        return false;
			...
			var url = "fieldtime.do?method=senddetails";
			document.forms[0].action = url;
			document.forms[0].submit();
		}
		...
		function test()
			{
			var url = "fieldtime.do?method=view";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		</script >
...
$(document).ready(function () {
    $(".submitBtn").click(function () {
		...
		<html:form action="/fieldtime">
			...
			<div class="right_content">
				...
				<div>
					<table class="background" style="height: 100px;width:1260;margin-left:55px;" >
						<tr class="rowHeader">
 ...
 <td id="bright">
				...
				<tr>
						...
						<td align="center">
						<display:table class="BinInfo" name="displaymanag" id="displaymanag" pagesize="25" requestURI="fieldtime.do" cellpadding="2" cellspacing="15">
