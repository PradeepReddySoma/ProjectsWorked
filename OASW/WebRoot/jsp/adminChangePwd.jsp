...
<html>
     ...
     if(f1.confirmPwd.value == "")
    {
        ...
        return false;
			...
			var url = "adminChangePwd.do?method=submitChangePwd";
	...
	<html:form action="/adminChangePwd">
		<body class="back">
			<div class="header">
			...
			<div class="right_content">
				...
				<div>
					<table class="background" id="changepwd" style="height: 100px;width:1260px;margin-left: 55px">
						<tr class="rowHeader">
						...
						<tr class="tablerowdark">
							<td class="leftie">
								<html:button property="method" styleClass="button_width2" styleId="labelButton"	
							 		style="width:150px;margin-top:0;margin-left:4px">User Name *</html:button>
							</td>
							<td>
						...
						<tr class="rowHeader">
							<th colspan="8" id="adminworkend">
								<html:button property="method" styleClass="button_width" onclick="changePassword()" style="margin-left:50px;margin-top:2px;">Submit</html:button>
							</th>
						</tr>
                    ...
                    <h2 style="color:blue;">Password has been Updated Successfully </h2>
                    <%}%>
                    <% 
                    if(request.getAttribute("msg2")!= null){ %>
                    <h2 style="color:blue;">The New Password and Confirm Password do not match </h2>
                    <%}%>
                    <% 
                    if(request.getAttribute("msg3")!= null){ %>
                    <h2 style="color:blue;">The Existing Password You entered is Wrong!</h2>
                    <%}%>
			</div>
			<div class="footers">
