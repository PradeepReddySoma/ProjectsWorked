...
<html>
	...
	function display()
           {
               var url = "contact_no.do?method=displayHistory";
		...
		<body class="back">	
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="contact_noForm" property="message" /></b>
				</div>
		...
		<tr class="tablerowdark">
			<td class="leftie">
								<%-- <html:button property="method" styleClass="button_width2"
							 		style="width:150px;margin-top:0;background-color: 	#3DBBD9;margin-left:4px">Contact Number</html:button> --%>
				...
				<table width="89%" cellpadding="1" cellspacing="1" class="background1" style="margin-left: 83px">
					...
					<tr>
						...
						<div class="scroll" style="margin-left: 83px;width: 89%" >
						    <display:table class="BinInfo" name="empmaster" id="empmaster" pagesize="25" requestURI="contact_no.do" cellpadding="3" cellspacing="3" export="true">
