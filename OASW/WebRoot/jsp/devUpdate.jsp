...
<html>
    ...
    if(f1.empRemarks.value== "")
    {
        ...
        return false;
				...
				var url = "devUpdate.do?method=updateTaskDetails";
		...
		<body class="back">
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="devUpdateForm" property="message" /></b>
				</div>
             ...
             <th colspan="10" id="displayworkstart">
						...
						<!-- <td>
							...
							<th colspan="" class="leftie" style="padding-top: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">
							    <html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:0px;">Unit *</html:button>
							</th>
						...
						<tr class="tablerowdark">
							...
							<th colspan="" class="leftie" style="padding-top: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">
							    <html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:0px;">Task_No. *</html:button>
							</th>
							<td>
							...
							<th colspan="" style="padding-top: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">
							    <html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:30px;">Task_Name *</html:button>
							</th>
							<td>
							...
							<th colspan="" style="padding-top: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">
							    <html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:-123px;px;">Update_Date *</html:button>
							</th>
							<td>
								<html:text property="taskUpdateDate" style="margin-right:100px;margin-left:10px;" styleClass="textField"  readonly="true"></html:text>
							</td>
							<td>
								<!-- <b style="margin-left: -310px">Emp_Name</b><font color="red" size="15px;">&nbsp;*</font> -->
								<html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:-290px;">Emp_Name *</html:button>
							</td>
							<td id="bright">
								<html:text property="empName" styleClass="textField" style="margin-left:-170px" readonly="true"></html:text>
							</td>
						</tr>
						<tr class="plainback">
							<td colspan="8" id="bright" class="leftie">&nbsp;</td>
						...
						<tr class="tablerowdark" style="height: 70px">
							<td class="leftie">
								...
								<html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:3px;">Status *</html:button>
							</td>
							<td>
								<html:select property="status" style="margin-left:18px;" styleClass="textField">
							...
							<td>
								...
								<html:button property="method" styleClass="button_width2" styleId="labelButton" style="margin-left:25px;width: 108px;">Emp_Remarks *</html:button>
							</td>
							<td colspan="6" id="bright">
								<html:textarea property="empRemarks" styleClass="textArea" style="width:720px;margin-bottom:-30px;margin-left:18px;"></html:textarea>
							</td>
							<!-- <td></td>
							 <td></td> -->
