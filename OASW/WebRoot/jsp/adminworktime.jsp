...
<html>
	<head>
			...
			function workdetails() 
		{
			...
			var url = "adminworktime.do?method=sendwork";
             ...
             if(f1.totime.value == "")
    {
        ...
        return false;
			...
			var url = "adminworktime.do?method=senddetails";
			document.forms[0].action = url;
			document.forms[0].submit();
		...
		function test()
			{
			var url = "adminworktime.do?method=view";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		</script >
...
<html:form action="/adminworktime">	
			...
			<div class="right_content">
				...
				<div>
					<table class="background" style="height: 100px;width:1260px;margin-left:55px;">
						...
						<td>
                              <html:text property="user" styleId="padleft"  styleClass="textField" readonly="true" style="margin-left:-40px"></html:text>
               </td>
							<td> 
								<%-- <html:button property="method" styleClass="button_width2"
						...
						<td>
                              <html:text property="starttime" onkeyup="" styleId="padleft"  styleClass="textField" readonly="true" style="margin-left:0px" disabled="disabled"></html:text>
               </td>
              <td id="bright">
								<html:button property="method" styleId="button1"  styleClass="button_width"   onclick="workdetails()" style="margin-right:180px" >Submit</html:button>
							</td>
                            </tr>   
                              <tr class="plainback" >
							<td colspan="8" id="bright" class="leftie">&nbsp;</td>
						...
						<td>
                              <html:text property="user1" styleId="padleft" styleClass="textField" readonly="true" style="margin-left:-40px"></html:text>
               </td>
								<td> 
								<%-- <html:button property="method" styleClass="button_width2"
 ...
 <td id="bright">
				...
				<table width="350px" cellpadding="1" cellspacing="1" align="center" class="background1">
					<tr class="rowHeader">
				...
				<tr>
						...
						<td align="center">
						<display:table class="historydistables" name="displaymanag" id="displaymanag" pagesize="25" requestURI="adminworktime.do" cellpadding="3" cellspacing="3">
							<display:column sortable="false" title="START TIME" property="stime"  headerClass="heading" style="width:150px" class="accountsh1"></display:column>
							<display:column sortable="false" title="END TIME" property="name" headerClass="heading" style="width:150px" class="accountsh1"></display:column>
