...
<html>
	...
	var URL = "accreports.do?method=displayrecord";
    ...
    if(f1.daily.value == "")
    {
        ...
        return false;
				...
				var url = "accreports.do?method=generatereport";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		...
		<div class="mainheader">
			...
			<div class="noscroll">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="accreportsForm" property="message" /></b>
				</div>
				<center>
			  ...
			  <html:hidden property="reportShow" />
					<table class="background" style="width: 1260px;margin-left:25px" >
						<tr class="rowHeader">
						...
						<th colspan="" class="leftie"
								...
								<html:button property="method" styleClass="button_width2" styleId="labelButton" styleId="labelButton"
									style="margin-left:3px;">Unit</html:button>
							</th>
...
<% %>
 ...
 <td class="leftie">
								<%-- <html:button property="method" styleClass="button_width2"
									...
									style="width:100px;margin-left:3px;">Sl.No *</html:button>
							</td>
<% if(list!=null){%>
  <td >
      <html:select property="slno" styleId="padleft" styleClass="textField" onchange="submitDetails()" style="width: 80px"  >
   ...
   <%} %>
							...
							<td>
								<html:text property="name" styleId="padleft" styleClass="textField" style="margin-left: 0px" readonly="true"></html:text>
							</td>
							<td>
								<%-- <html:button property="method" styleClass="button_width2"
