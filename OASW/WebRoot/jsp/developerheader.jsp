				...
				<div class="nav_area1">
					<div class="main_wrap">
						...
						<!--<font style="margin-left: 150px;font-size: 22px;color: blue;font-weight: bold;">IngrOInfo Work Management Solutions<br/><br/></font>
							--><div class="nav_wrap">
								<ul class="nav main" style="width: 780px;margin-left: 440px">
								
								<li>
										<a href="devtime.do?method=display"  id="marright" class="home">Timing</a>
								<ul>
								<li>
										<a href="dailywork.do?method=display"  id="marright"  class="home">Work Details</a>
									</li>
									</ul>
									</li>
									<li>
										<a href="devtask.do?method=display"  id="marright" class="home">Task</a>
									<ul>	<li>
										<a href="workview.do?method=display"  id="marright" class="home">Updated Tasks</a>
									</li>
									...
									<li>
										<a href="devchangepwd.do?method=display"  id="marright" class="home">Change Password</a>
									</li>
									<li>
