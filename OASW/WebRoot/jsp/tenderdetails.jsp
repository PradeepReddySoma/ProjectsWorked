...
<script>
    ...
    return false;
				...
				var url = "tenderdetails.do?method=click";
			...
			function history()
			{
				var url = "tenderdetails.do?method=check";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		</script>
<style type="text/css">
    ...
    <html:form action="/tenderdetails"  method="post" enctype="multipart/form-data">
		<body class="back">
			<div class="header">
	<jsp:include page="empHeader.jsp"></jsp:include>
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="tenderDetailsForm" property="message" /></b>
				</div>
				</div>
  <div>	
  <br/>
  <br/>
<table class="background" style="width: 1345px;margin-left: 12px">
						<tr class="rowHeader">
					...
					<th colspan="" class="leftie"
						...
						<td colspan="10"  id="bright">
				          <html:text property="unit" readonly="true" styleId="padleft" style="height:30;width:100;margin-top:20" styleClass="textField" style="width:250px" ></html:text>
				 ...
				 <tr class="tablerowdark">
						...
						<td>
								<%-- <html:button property="method" styleClass="button_width2"
									...
									<html:button property="method" styleClass="button_width2" styleId="labelButton"
									style="width:250px;margin-left:4px;">Tender Details *</html:button>
							</td>
						<td>
								<%-- <html:button property="method" styleClass="button_width2"
									style="width:120px;margin-left:5px;background-color: #F5A13B">Contact Name</html:button> --%>
		                 ...
		                 <tr class="tablerowdark">
		                   ...
		                   <html:text property="datepick" styleId="datepicker" styleClass="textField"   style="width:80px;margin-left:5px;padding-left:4px;" readonly="true"></html:text>
							...
							<td>
			                   ...
			                   <td>
							<html:text property="tender" styleId="padleft" styleClass="textField" style="width:250px;" ></html:text>
							</td>
							 <td>
		                   <html:text property="contname" styleId="padleft"  styleClass="textField" style="width:120px;margin-left:5px; " ></html:text>
							</td>
			                 <td>
		                   <html:text property="contno"  styleId="padleft" styleClass="textField" style="width:100px;margin-left:15px;" ></html:text>
							</td>
			                 <%-- <td>
		                   <html:text property="calldat" styleId="datepicker1" styleClass="textField" style="width:100px;margin-left:20px;padding-left:4px; " readonly="true"></html:text>
							</td> --%>
			                 <td>
		                   <html:text property="lastdat" styleId="datepicker2" styleClass="textField" style="width:100px;margin-left:10px;padding-left:4px;" readonly="true"></html:text>
			                 ...
			                 <td >
							<html:text property="employ" styleId="padleft" styleClass="textField" style="width: 100px;margin-left:10px" ></html:text>
							</td>
			               <td id="bright">
							<html:file property="file" styleId="padleft" style="width: 180px; margin-left:10px;cursor:pointer;" ></html:file>
							</td>
						...
						<tr class="rowHeader">
							<th colspan="20" id="adminworkend" style="padding-top: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;">
