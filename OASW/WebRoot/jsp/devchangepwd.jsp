...
<html>
     ...
     if(f1.confirmPwd.value == "")
    {
        ...
        return false;
			...
			var url = "devchangepwd.do?method=submitChangePwd";
		...
		<body class="back">
			...
			<div class="right_content">
				<div style="font-size: 15px; text-align: center; margin-bottom: 10px;">
					<b><bean:write name="devchangepwdForm" property="message" /></b>
				</div>
				<div>
  ...
  <th colspan="10" style="padding-top: 5px;border-top-right-radius: 5px;border-top-left-radius: 5px;border:2px solid #2D659F;">
						...
						<tr class="tablerowdark">
							<td class="leftie">
								<%-- <html:button property="method" styleClass="button_width2"
							 		...
							 		style="width:150px;margin-top:0;margin-left:2px">User Name *</html:button>
							</td>
							<td>
								<html:text property="userName1"  styleId="padleft" styleClass="textField" readonly="true"></html:text>
							</td>
							<td>
								<%-- <html:button property="method" styleClass="button_width2"
						...
						<tr class="rowHeader">
							<th colspan="8" style="padding-top: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;border:2px solid #2D659F;">
