...
<html> 
	<head>
		<title>JSP for Company Account form</title>
    ...
    function submit12()
   {
    ...
    var url = "companyAccount.do?method=accsub";
   ...
   function display()
   {
    ...
    var url = "companyAccount.do?method=accountDetails";
    document.forms[0].action = url;
    document.forms[0].submit();
   }
    function Back12()
	...
	width: 100%;
		...
		<body class="back">
			<div class="header">
				...
				<b><bean:write name="companyAccountForm" property="message" /></b>
			</div>
			<div>
					...
					<table class="background" style="margin-left:85px">
						<tr class="rowHeader">
								...
								<b style="font-family: serif;font-size: 20px;">Company Bank Account</b>
							</th>
						...
						<td>
				        <html:select property="year" styleClass="textField" style="width:80px;margin-left:-50px">
						...
						<tr class="tablerowdark">
							...
							<td>
                              ...
                              <html:text property="name" style="height:30;width:100;margin-top:20" styleClass="textField" style="width:150px" ></html:text>
							...
							<td>
								...
								<td>
								<html:text property="code" styleClass="textField" style="width:120px" ></html:text>
							</td>	
							...
							<td>
								<html:text property="address" styleClass="textField" style="width:120px"></html:text>
							</td>
						...
						<tr class="rowHeader">
							<th colspan="10" style="padding-top: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;">
								<html:button property="method" styleClass="button_width"  style="margin-left:50px;" onclick="submit12()">Submit</html:button>
								<html:button property="method" styleClass="button_width"  style="margin-left:50px;" onclick="display()">History</html:button>
								<html:button property="method" styleClass="button_width"  style="margin-left:50px;" onclick="Back12()">Back</html:button>
							</th>
						</tr>
				...
				<table width="88%" cellpadding="1" cellspacing="1" align="center" class="background1" style="margin-left:85px">
					<tr class="rowHeader">
						<th colspan="8" style="padding-top: 10px;">
							<b class="fontProp" style="font-size: 20px;">Company Account Details</b>
						</th>
					</tr>
					<tr>
						<td>
