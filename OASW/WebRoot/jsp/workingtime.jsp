...
<html>
             ...
             if(f1.starttime.value == "")
    {
        ...
        return false;
			...
			var url = "workingtime.do?method=sendwork";
             ...
             if(f1.totime.value == "")
    {
        ...
        return false;
			...
			var url = "workingtime.do?method=senddetails";
			document.forms[0].action = url;
			document.forms[0].submit();
		...
		function test()
			{
			var url = "workingtime.do?method=view";
				document.forms[0].action = url;
				document.forms[0].submit();
			}
		</script >
...
$(document).ready(function () {
    $(".submitBtn").click(function () {
		...
		<html:form action="/workingtime">
			...
			<div class="right_content">
				...
				<div>
					<table class="background" id="tablecss" style="height: 100px;margin-left:55px;" >
						<tr class="rowHeader">
						...
						<td> 
								<%-- <html:button property="method" styleClass="button_width2"
									style="width:100px;margin-left:0px;background-color: #286624">Start Time *</html:button> --%>
									<html:button property="method" styleClass="button_width2" styleId="labelButton"
              ...
              <td id="bright">
						...
						<td>
							...
							<td> 
								<%-- <html:button property="method" styleClass="button_width2"
									style="width:100px;margin-left:0px;background-color: #d31515">End Time *</html:button> --%>
									<html:button property="method" styleClass="button_width2" styleId="labelButton"
 ...
 <td id="bright">
				...
				<tr>
						...
						<display:table class="historydistables" name="displaymanag" id="displaymanag" pagesize="25" requestURI="workingtime.do" cellpadding="2" cellspacing="15">
